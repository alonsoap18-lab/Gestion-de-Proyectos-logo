    ...
    <div className="min-h-screen bg-surface-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 opacity-20"
          style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(45,79,160,0.25) 1px, transparent 0)', backgroundSize: '40px 40px' }}/>
        ...
        <div className="card p-7 shadow-2xl border-surface-600">
          ...
          <div className="mt-5 pt-5 border-t border-surface-600">
            <div className="bg-surface-700 rounded-lg p-3 font-mono text-xs space-y-1 border border-surface-600">
              <div><span className="text-slate-500">usuario: </span><span className="text-[#4a7fd4]">admin@grupoicaa.com</span></div>
              <div><span className="text-slate-500">clave:   </span><span className="text-[#4a7fd4]">ICAAadmin2026</span></div>
            </div>
          </div>
        </div>
